...
export function ReservationModal({ 
  ...
  const getDefaultValues = () => {
    ...
    // Format: YYYY-MM-DDThh:mm unter Nutzung der definierten Funktion
                  ...
                  >
                    ...
                    <SelectContent>
                      {vehicles.map(vehicle => {
                        // Farbdarstellung im Dropdown-Menü für visuelle Konsistenz
                        const defaultColorHues = [210, 160, 340, 20, 270, 60, 310];
                        const colorHue = vehicle.colorHue || defaultColorHues[vehicles.indexOf(vehicle) % defaultColorHues.length];
                        const colorStyle = {
